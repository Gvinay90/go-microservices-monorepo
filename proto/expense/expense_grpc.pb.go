...
const (
	...
	ExpenseService_ListExpenses_FullMethodName  = "/expense.ExpenseService/ListExpenses"
	ExpenseService_GetBalances_FullMethodName   = "/expense.ExpenseService/GetBalances"
	ExpenseService_SettleBalance_FullMethodName = "/expense.ExpenseService/SettleBalance"
)
...
func (c *expenseServiceClient) GetBalances(ctx context.Context, in *GetBalancesRequest, opts ...grpc.CallOption) (*GetBalancesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBalancesResponse)
	err := c.cc.Invoke(ctx, ExpenseService_GetBalances_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *expenseServiceClient) SettleBalance(ctx context.Context, in *SettleBalanceRequest, opts ...grpc.CallOption) (*SettleBalanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SettleBalanceResponse)
	err := c.cc.Invoke(ctx, ExpenseService_SettleBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExpenseServiceServer) GetBalances(context.Context, *GetBalancesRequest) (*GetBalancesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBalances not implemented")
}
func (UnimplementedExpenseServiceServer) SettleBalance(context.Context, *SettleBalanceRequest) (*SettleBalanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SettleBalance not implemented")
}
...
func _ExpenseService_GetBalances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBalancesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExpenseServiceServer).GetBalances(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExpenseService_GetBalances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExpenseServiceServer).GetBalances(ctx, req.(*GetBalancesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ExpenseService_SettleBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SettleBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExpenseServiceServer).SettleBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExpenseService_SettleBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExpenseServiceServer).SettleBalance(ctx, req.(*SettleBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExpenseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ExpenseService_GetBalances_Handler,
		},
		{
			MethodName: "SettleBalance",
			Handler:    _ExpenseService_SettleBalance_Handler,
		},
	},
